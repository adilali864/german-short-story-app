...
const StoryPage = () => {
  ...
  return (
    <>
      ...
      <article className="h-full overflow-y-auto bg-[#ecfbff]">
        ...
        <div className="max-w-xl mx-auto px-6 -mt-50 relative z-10">
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            ...
            <Link
              to="/"
              className="mt-4 mb-20 inline-block text-blue-600 font-semibold"
            >
